...
//              virtual bool VisitObjCContainerDecl(clang::ObjCContainerDecl * objc_container_decl, NodeDescriptor & node_desc);
//                  virtual bool VisitObjCCategoryDecl(clang::ObjCCategoryDecl * objc_categoty_decl, NodeDescriptor & node_desc);
//                  virtual bool VisitObjCImplDecl(clang::ObjCImplDecl * objc_impl_decl, NodeDescriptor & node_desc);
//                      virtual bool VisitObjCCategoryImplDecl(clang::ObjCCategoryImplDecl * objc_category_impl_decl, NodeDescriptor & node_desc);
//                      virtual bool VisitObjCImplementationDecl(clang::ObjCImplementationDecl * objc_implementation_decl, NodeDescriptor & node_desc);
//                  virtual bool VisitObjCInterfaceDecl(clang::ObjCInterfaceDecl * objc_interface_decl, NodeDescriptor & node_desc);
//                  virtual bool VisitObjCProtocolDecl(clang::ObjCProtocolDecl * objc_protocol_decl, NodeDescriptor & node_desc);
//              virtual bool VisitObjCMethodDecl(clang::ObjCMethodDecl * objc_method_decl, NodeDescriptor & node_desc);
//              virtual bool VisitObjCPropertyDecl(clang::ObjCPropertyDecl * objc_property_decl, NodeDescriptor & node_desc);
...
//                          virtual bool VisitObjCAtDefsFieldDecl(clang::ObjCAtDefsFieldDecl * objc_at_defs_field_decl, NodeDescriptor & node_desc);
//                          virtual bool VisitObjCIvarDecl(clang::ObjCIvarDecl * objc_ivar_decl, NodeDescriptor & node_desc);
    ...
    //              virtual bool VisitBinaryConditionalOperator(clang::BinaryConditionalOperator * binary_conditionnal_operator, NodeDescriptor & node_desc);
    ...
    //          virtual bool VisitBinaryTypeTraitExpr(clang::BinaryTypeTraitExpr * binary_type_trait_expr, NodeDescriptor & node_desc);
    //          virtual bool VisitBlockDeclRefExpr(clang::BlockDeclRefExpr * block_decl_ref_expr, NodeDescriptor & node_desc);
    ...
    //          virtual bool VisitCXXBoolLiteralExpr(clang::CXXBoolLiteralExpr * cxx_bool_literal_expr, NodeDescriptor & node_desc);
                virtual bool VisitCXXConstructExpr(clang::CXXConstructExpr * cxx_constructor_expr, NodeDescriptor & node_desc);
    ...
    //          virtual bool VisitCXXNoexceptExpr(clang::CXXNoexceptExpr * cxx_noexecept_expr, NodeDescriptor & node_desc);
    ...
    //          virtual bool VisitExprWithCleanups(clang::ExprWithCleanups * expr_with_cleanups);
        ...
        //              virtual bool VisitObjCEncodeExpr(clang::ObjCEncodeExpr * objc_encoder_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCIsaExpr(clang::ObjCIsaExpr * objc_isa_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCIvarRefExpr(clang::ObjCIvarRefExpr * objc_ivar_ref_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCMessageExpr(clang::ObjCMessageExpr * objc_message_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCPropertyRefExpr(clang::ObjCPropertyRefExpr * objc_propery_ref_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCProtocolExpr(clang::ObjCProtocolExpr * objc_protocol_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCSelectorExpr(clang::ObjCSelectorExpr * objc_selector_expr, NodeDescriptor & node_desc);
        //              virtual bool VisitObjCStringLiteral(clang::ObjCStringLiteral * objc_string_literal, NodeDescriptor & node_desc);
            ...
            //          virtual bool VisitParenListExpr(clang::ParenListExpr * paren_list_expr, NodeDescriptor & node_desc);
            ...
            //          virtual bool VisitUnaryTypeTraitExpr(clang::UnaryTypeTraitExpr * unary_type_trait_expr, NodeDescriptor & node_desc);
        ...
        //          virtual bool VisitObjCAtCatchStmt(clang::ObjCAtCatchStmt * objc_catch_stmt, NodeDescriptor & node_desc);
        //          virtual bool VisitObjCAtFinallyStmt(clang::ObjCAtFinallyStmt * objc_finally_stmt, NodeDescriptor & node_desc);
        //          virtual bool VisitObjCAtSynchronizedStmt(clang::ObjCAtSynchronizedStmt * objc_synchronized_stmt, NodeDescriptor & node_desc);
        //          virtual bool VisitObjCAtThrowStmt(clang::ObjCAtThrowStmt * objc_throw_stmt, NodeDescriptor & node_desc);
        //          virtual bool VisitObjCAtTryStmt(clang::ObjCAtTryStmt * objc_try_stmt, NodeDescriptor & node_desc);
        //          virtual bool VisitObjCAtForCollectionStmt(clang::ObjCAtForCollectionStmt * objc_for_collection_stmt, NodeDescriptor & node_desc);
